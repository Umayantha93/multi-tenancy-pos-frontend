...
export function Panel({ children, className = "" }: { children: ReactNode; className?: string }) { return <section className={`min-w-0 border border-[#d7d3c8] bg-[#fbfaf6] ${className}`}>{children}</section>; }

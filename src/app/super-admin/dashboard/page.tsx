...
export default function PlatformDashboardPage() {
  ...
  return <PlatformShell title="Platform pulse" action={<Link href="/super-admin/tenants/new" className="flex h-8 items-center gap-2 bg-[#f5c842] px-2.5 text-[11px] font-semibold"><Plus size={18} />New tenant</Link>}>
